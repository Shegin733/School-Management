...
class UserProfileView(APIView):
    ...
    def get(self, request):
        ...
        # Serialize the basic user information
        try:
...
class RetrieveRoleProfileView(APIView):
    ...
    def get(self, request, id):
        ...
        user = request.user
        try:
            # Fetch the user and their role-specific profile
...
class RetrieveProfilesView(APIView):
    ...
    def get(self, request, role):
        ...
        for user in users:
            ...
            # Add role-specific profile with error handling for missing profiles
            profile_data = {}
            try:
                if role == 'admin':
...
class DeleteProfileView(APIView):
    ...
    def delete(self, request, id):
        ...
        try:
            # Retrieve the user whose profile is to be deleted
            user_to_delete_profile = User.objects.get(id=id)

            # Delete the corresponding profile based on the user's role
